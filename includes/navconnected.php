			...
			<div class="row main-top-w3l py-2">				
				...
				<div class="col-lg-8 header-right mt-lg-0 mt-2">
					...
					<ul>
						...
						<li class="text-center border-right text-white">
							<a href="contact." class="text-white" style="font-size:16px">
								 <b>Contect Us</b> </a>
						</li>
						<li class="text-center border-right text-white">
							<a href="includes/logout." class="text-white" style="font-size:16px">
								 <b>Logout</b> 
							</a>
						</li>
						<li class="text-center border-right text-white">
							<a href="viewprofile." class="text-white" style="font-size:16px">
								 <b>View Profile</b> </a>
						</li>
						<li class="text-center text-white">
							
							<img src="userimage/<? echo $_SESSION['image'];?>" alt="" class="img-fluid" height="35px" width="35px" style="border-radius:9px" > 
							&nbsp;&nbsp <b style="font-size:16px">Hi <? echo $_SESSION['firstname'];?></b>
			...
			<div class="row header-bot_inner_wthreeinfo_header_mid">
				...
				<div class="col-md-9 header mt-4 mb-md-0 mb-4">
					<div class="row">
					   ...
					   <!--- <div class="col-2 agileits_search">
							<a href="includes/logout." style="color: red; font-size:20px">
							logout
						</a>
						</div>--->
						<!-- //cart details -->
