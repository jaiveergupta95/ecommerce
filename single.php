...
$subbid=$_GET['ppid'];
$catname=$_GET['catnam'];
$prorun = "select * from  product where ProcuctId='$subbid' && Status='Enable'";
	...
	<div class="banner-bootom-w3-agileits py-5">
		<div class="container py-xl-4 py-lg-2">
			...
			<h3 class="tittle-w3l text-center mb-lg-5 mb-sm-4 mb-3">
				<span style="color:red; font-size:37px"><?php echo strtoupper($row['Productuname']); ?></span>
				<span></span></h3>
			<!-- //tittle heading -->
			<div class="row">
				<div class="col-lg-5 col-md-8 single-right-left ">
					<div class="grid images_3_of_2">
						<div class="flexslider" style="height:300px; width:250px">
							<ul class="slides">
								<li>
									
								    <img src="adminn/productimage/<?php echo $row['Image1']; ?>" data-imagezoom="true" class="img-fluid" alt=""> 
										
								</li>
								<li>
									<img src="adminn/productimage/<?php echo $row['Image2']; ?>" data-imagezoom="true" class="img-fluid" alt=""> 
								</li>
								<li>
									<img src="adminn/productimage/<?php echo $row['Image3']; ?>" data-imagezoom="true" class="img-fluid" alt=""> 
								</li>
							</ul>
				...
				<div class="col-lg-7 single-right-left simpleCart_shelfItem">
					<h3 class="mb-3"><?php echo $row['Description']; ?></h3>
					<p class="mb-3">
						<span class="item_price">&#8377;<?php echo $row['SelllingPrice']; ?></span>
						<del class="mx-2 font-weight-light">&#8377;<?php echo $row['ActualPrice']; ?></del>
